...
import './bible-explorer.js?v=8.66-timeline-search1';
...
function clearAuthAndRedirect(reason) {
  ...
  window.location.replace('./login.html?v=8.66-timeline-search1' + (authReason ? '&auth_error=' + encodeURIComponent(authReason) : ''));
}
