...
import './bible-explorer.js?v=8.67-cache-dictionary1';
...
function clearAuthAndRedirect(reason) {
  ...
  window.location.replace('./login.html?v=8.67-cache-dictionary1' + (authReason ? '&auth_error=' + encodeURIComponent(authReason) : ''));
}
