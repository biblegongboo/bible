...
import './bible-explorer.js?v=8.68-timeline-cursor1';
...
function clearAuthAndRedirect(reason) {
  ...
  window.location.replace('./login.html?v=8.68-timeline-cursor1' + (authReason ? '&auth_error=' + encodeURIComponent(authReason) : ''));
}
