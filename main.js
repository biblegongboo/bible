...
import { isSuperGraphicPayload, preloadSuperGraphicEngine, renderSuperGraphicPayload } from './graphics/graphic-router.js?v=8.33-journey1-zoom1';
import './bible-explorer.js?v=8.33-journey1-zoom1';
