...
const checks = [
  ...
  ['release HTML requests the current main bundle', index.includes('main.js?v=9.44-sermon-prefetch-scroll1')]
  ,['main requests the current Explorer bundle', main.includes('bible-explorer.js?v=9.29-sermon-prefetch-scroll1')]
