...
const checks = [
  ...
  ['release HTML requests the current main bundle', index.includes('main.js?v=9.46-library-search-standard2')]
  ,['main requests the current Explorer bundle', main.includes('bible-explorer.js?v=9.31-library-search-standard2')]
