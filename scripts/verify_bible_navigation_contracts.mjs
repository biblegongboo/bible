...
const checks = [
  ...
  ['release HTML requests the current main bundle', index.includes('main.js?v=9.47-all-search-standard1')]
  ,['main requests the current Explorer bundle', main.includes('bible-explorer.js?v=9.32-all-search-standard1')]
