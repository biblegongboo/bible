...
const checks = [
  ...
  ['release HTML requests the current main bundle', index.includes('main.js?v=9.42-sermon-search-pilot2')]
  ,['main requests the current Explorer bundle', main.includes('bible-explorer.js?v=9.27-sermon-search-pilot2')]
