...
const checks = [
  ...
  ['release HTML requests the current main bundle', index.includes('main.js?v=9.43-sermon-load-more1')]
  ,['main requests the current Explorer bundle', main.includes('bible-explorer.js?v=9.28-sermon-load-more1')]
