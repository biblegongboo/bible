...
const checks = [
  ...
  ['nested Explorer cache is refreshed', main.includes('bible-explorer.js?v=9.31-library-search-standard2')],
  ['release HTML requests the pilot bundle', html.includes('main.js?v=9.46-library-search-standard2')]
];
